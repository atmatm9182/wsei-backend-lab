    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder
            ...
            .HasData(
                ...
                {
                    Id = 1,
                    Email = "email@wsei.edu.pl",
                    Password = "Str0ngPa$$word"
                }
            );

        modelBuilder
            .Entity<QuizItemUserAnswerEntity>()
            .HasOne<QuizEntity>()
            .WithMany()
        ...
        modelBuilder.Entity<QuizItemUserAnswerEntity>().HasOne(e => e.QuizItem);

        modelBuilder
            .Entity<QuizItemAnswerEntity>()
            .HasData(
        ...
        modelBuilder
            .Entity<QuizEntity>()
            .HasData(
                new QuizEntity() { Title = "Matematyka", Id = 1 },
                new QuizEntity() { Title = "Arytmetyka", Id = 2 }
            );
